...
#pragma warning disable 0649 // Field is never assigned to, and will always have its default value null
    ...
    [Tooltip("Change the movement multiplier to match the frame graphic's size.")] [SerializeField]
    private float movementMultiplier;

    [Tooltip("Lock the horizontal axis to only position vertically. This can help to simplify the position guide for headsets that don't have physical IPD adjustment.")]
    [SerializeField]
    private bool lockX;
